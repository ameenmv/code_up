          ...
          >
            ...
            >
              <div className="flex flex-col sm:flex-row h-full">
                <div className="w-full sm:w-48 h-40 sm:h-auto shrink-0 relative overflow-hidden">
                  <img src={course.thumbnail} alt={course.title.en} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-dark-950 to-transparent sm:hidden" />
                </div>
                <div className="p-6 flex flex-col justify-center flex-grow">
                  <h3 className="font-bold text-lg mb-2 group-hover:text-brand-purple transition-colors">{course.title.en}</h3>
                  <p className="text-sm text-white/50 mb-4 line-clamp-2">{course.short_description.en}</p>
